<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./application/admin/view/user/index.html";i:1547631235;s:63:"/wanma/www/beautyshop/application/admin/view/public/layout.html";i:1546589238;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="flexigrid">
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <div class="fbutton">
                    <a href="<?php echo U('User/robot'); ?>">
                        <div class="add" title="添加机器人">
                            <span><i class="fa fa-plus"></i>添加机器人</span>
                        </div>
                    </a>
                </div>
